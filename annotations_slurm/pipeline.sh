...
JOB_ID1=$(sbatch --parsable --partition=normal --time 48:00:00 --mem 16G --job-name gpt_annotation --wrap "$ACTIVATE_ENV;$RUN_ANNOTATION" --output ./slurm_outputs/output_%j.log --error ./slurm_errors/error_%j.err)